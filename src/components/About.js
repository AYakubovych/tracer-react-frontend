...
export default function About() {
    ...
    return (
        <div className='wrapper' style={{marginTop:'15px'}}>
            <div className="centered_home_div" style={{textAlign:'left'}}>
                <h5 >
                ...
                <h5>
                    ...
                    To create this service I had involved Java 8+, Spring(Boot, Data, MVC), PostgreSQL and Maven.
                </h5>
                <br/>
                <h5>
                    ...
                    Maven, Hibernate, JWT and PostgreSQL.
                </h5>
                <br/>
                <h5>
